...
@section('content2')
    <section class="hero">
            <div class="container3">
                ...
                <p>Kami berdedikasi menyediakan berbagai layanan kesehatan terjangkau & mengedepankan kenyamanan dengan tim profesional dan fasilitas modern untuk kebutuhan kesehatan Anda</p>
            </div>
    </section>
    <!-- Content -->
    <div class="container">
